...
if (isset($_POST['submit'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<script>alert('Email ou Mot de passe incorecte.')</script>";
    }
}
...
<body>
    <div class="container">
        <form action="" method="POST" class="login-email">
            ...
            <p class="login-register-text">Vous n'avez pas de compte ? <a href="register.php">Enregistrez-vous ici</a>.</p>
        </form>
    </div>
</body>
</html>